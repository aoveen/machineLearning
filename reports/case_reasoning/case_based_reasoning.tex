...
\begin{tabular}{|l|l|c|c|}
	\cline{3-4}
	\multicolumn{2}{c}{}& \multicolumn{2}{ |c| }{Average Classification Error Rate}\\
	\cline{3-4}
	\multicolumn{2}{c|}{} & Clean & Noisy \\ \cline{1-4}
	\multirow{10}{*}{Similarity Measure}& Dice Dissimilarity & 0.1910 & 0.3820   \\ \cline{2-4}
	& Jaccard & 0.1910 & 0.3820  \\ \cline{2-4}
	& Matching Dissimilarity & 0.1400 & 0.2970   \\ \cline{2-4}
	& RR Dissimilarity & 0.2740  & 0.4070  \\ \cline{2-4}
	& RT Dissimilarity & 0.1400  & 0.2970   \\ \cline{2-4}	
	& Rubbish & 0.8070 & 0.8130  \\ \cline{2-4}
	& Shared AUs & 0.1400 & 0.2970   \\ \cline{2-4}
	& SS Dissimilarity & 0.1910 & 0.3820  \\ \cline{2-4}
	& Weighted & 0.1330 & 0.3180   \\ \cline{2-4}
