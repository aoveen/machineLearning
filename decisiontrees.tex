...
\begin{figure}[p]
	\centering
	\includegraphics[height=\textheight, width=\textwidth]{images/flow_chart/cross_fold_validation.png}
...
\begin{figure}[p]
	\centering
	\includegraphics[height=\textheight, width=10cm]{images/flow_chart/create_folds.png}
...
\begin{figure}[]
	\centering
	\includegraphics[height=11cm, width=10cm]{images/flow_chart/build_tree.png}
...
\begin{figure}[]
	\centering
	\includegraphics[height=11cm, width=10cm]{images/flow_chart/binary_filter.png}
...
\begin{figure}[p]
		\centering
		\includegraphics[height=\textheight]{images/flow_chart/testtrees.png}
     	\caption{Flowchart of \tt{testtrees}}
     	\label{fig:testtrees}
\end{figure}
